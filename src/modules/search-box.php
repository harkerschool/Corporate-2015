    ...
    <div class="fsElementContent">
        <script>
            (function() {
              ...
              if(document.getElementById(scriptCoreId) == null) {
                var cx = '003863166793472101546:6x_zbtwwo5c';
                var gcse = document.createElement('script');
                gcse.type = 'text/javascript';
                gcse.async = true;
                gcse.src = '//www.google.com/cse/cse.js?cx=' + cx;
                gcse.id = scriptCoreId;
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="gsc-branding-img">
                                    <img src="https://www.google.com/uds/css/small-logo.png" class="gsc-branding-img"></td>
                            </tr>
                        </tbody>
                    </table>
                </form>
